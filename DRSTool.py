...
def create_all_settings() -> List[Setting]:
    ...
    settings.extend([
        ...
        Setting("0x10562D0F", "DLSSG Dynamic Max", "DLSS / NGX", "numeric", "0",
                ...
                min=0, max=16777215),
        Setting("0x10CF4125", "DLSSG Target FPS", "DLSS / NGX", "dec-hex", "0x0",
                "DLSSG Target FPS",
    ...
    settings.extend([
        ...
        Setting("0x10D1EF29", "GPU Max Power", "Power", "dec-hex", "0x0",
                "GPU Max Power",
    ...
    settings.extend([
        Setting("0x007BA09E", "Pre-Render Limit", "Frame Rate", "numeric", "0",
                ...
                min=0, max=255),
        Setting("0x10835002", "FPS Limiter", "Frame Rate", "dec-hex", "0x0",
                "FPS Limiter",
                "Hard frame rate cap. 60=0x3C, 120=0x78, 144=0x90"),
        Setting("0x10835016", "Idle FPS Limit", "Frame Rate", "dec-hex", "0x14",
                "Idle FPS Limit",
